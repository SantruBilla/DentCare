                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        ...
                        <a href="https://www.instagram.com/dent_care_dental_clinic/" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-dental-teal transition-colors">@dent_care_dental_clinic</a>
                      </div>
                    </div>
                  </div>
                </div>
